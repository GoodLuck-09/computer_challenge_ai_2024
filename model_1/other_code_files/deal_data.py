...
def deal_train_data(to_train_dir):
    ...
    # 保存真实官方账号名
    real_official_name_dicts = {'name': real_official_name}
    df = pd.DataFrame(real_official_name_dicts)
    df.to_csv('./real_official_name.csv', mode='w', index=False, header=False)
